      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-x-4 gap-y-10 md:gap-8 mb-10">
          ...
          <div className="col-span-2 md:col-span-1">
            <m.div whileHover={{ scale: 1.05, rotate: -2 }} whileTap={{ scale: 0.95 }} className="inline-block origin-left">
              <button
                type="button"
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <address className="not-italic space-y-2 mb-4 text-xs sm:text-sm text-zinc-300">
              ...
              <p className="pt-1">
                <a href="tel:+447761735022" className="hover:text-blue-500 transition-colors">07761 735022</a><br/>
            ...
            <m.div whileHover={{ scale: 1.05, y: -2 }} whileTap={{ scale: 0.95 }} className="inline-block">
              <a
