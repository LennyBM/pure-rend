...
export const metadata: Metadata = {
  ...
  title: "PureRend | Elite Architectural Rendering in Bude",
  description: "Specialist Silicone Rendering, Monocouche, and EWI in Bude.",
  icons: {
